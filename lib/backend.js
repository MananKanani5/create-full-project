...
export {};`;
  ...
  console.log(chalk.gray("   - Advanced query builder (search, filter, sort, pagination)"));
  console.log(chalk.gray("   - Enhanced middleware (sanitize, notFound, error handling)"));
